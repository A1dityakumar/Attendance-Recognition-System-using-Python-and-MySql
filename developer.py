...
# This part is image labels setting start 
        # first header image  
        img=Image.open(r"C:\Users\Aditya Kumar\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bg1.jpg")
        ...
        # backgorund image 
        bg1=Image.open(r"C:\Users\Aditya Kumar\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bg4.png")
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"C:\Users\Aditya Kumar\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\adityaselfie.jpeg")
        ...
        std_b1_1 = Button(bg_img,text="Aditya Kumar",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=250,y=380,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"C:\Users\Aditya Kumar\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\aryan.jpg")
        ...
        det_b1_1 = Button(bg_img,text="Aryan Chaudhari",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=480,y=380,width=180,height=45)

        #  # Attendance System  button 3
        att_img_btn=Image.open(r"C:\Users\Aditya Kumar\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\sidd.jpeg")
        ...
        att_b1_1 = Button(bg_img,text="Siddhant Desai",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
