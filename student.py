...
# Testing Connection 
"""
conn = mysql.connector.connect(username='root', password='Aditya@604',host='localhost',database='face_recognition',port=3307)
cursor = conn.cursor()
...
class Student:
    ...
    # This part is image labels setting start 
        ...
        f_lb1.place(x=0,y=0,width=1366,height=130)
         ...
         # backgorund image 
        bg1=Image.open(r"C:\Users\Aditya Kumar\Python-FYP-Face-Recognition-Attendence-System-master\Images_GUI\bg3.jpg")
        ...
        dep_combo["values"]=("Select Department","Entc","Comp","Chemical","AI-DS","Mech")
        dep_combo.current(0)
